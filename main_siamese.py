...
mining_tech = 'Siamese' #Siamese, Triplet, Doppleganger
batch_size = 81
margin = 1.
lr = 0.01
n_epochs = 20
...
fit(train_loader, val_loader, model, loss_fn, optimizer, scheduler, n_epochs, cuda, log_interval, mining_tech='Siamese')
